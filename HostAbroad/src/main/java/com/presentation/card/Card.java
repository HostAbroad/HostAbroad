...
public class Card extends Panel {
	...
	public Card(TUser tUser) {
		...
		stars.setValue(tUser.getRating());
	...
	/**
	 * private VerticalLayout createLeftPartOfCard(String nickname) Creates inner
	 * layout for the left part of the panel(containing nickname and photo)
	 */
	...
	/**
	 * private VerticalLayout createRightPartOfCard(String description) Creates
	 * inner layout for the right part of the panel(containing user description)
	 */
	private VerticalLayout createRightPartOfCard(TUser tUser) {
		...
		acceptLikes.addClickListener(event -> {
			...
			if (result.getLeft() == 1) {
				...
				Notification notA = new Notification("Like Accepted!", "Click My Profile to update your changes!",
		...
		declineLikes.addClickListener(event -> {
			...
			if (result.getLeft() == 1) {
				...
				Notification notD = new Notification("Like Declined!", "Click My Profile to update your changes!",
						Notification.Type.HUMANIZED_MESSAGE);
